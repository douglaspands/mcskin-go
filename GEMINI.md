...
- **Skills** (`.agents/skills/`): `bedrock-skin-pack-verifier`, `openspec-apply-change`, `openspec-archive-change`, `openspec-explore`, `openspec-propose`, `openspec-sync-specs`, `openspec-update-change`, `prototype-iteration-loop`, `static-server-dev`, `ui-component-library-ref`, `web-prototype-scaffold`.
