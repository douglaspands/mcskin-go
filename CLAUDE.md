...
- **Allowed Harmless Commands**: `go test ...`, `go build ...`, `go vet ...`, `go run ...`, `go fmt ...`, `go mod tidy`, `make ...`, `./scripts/test-compact.sh`, `./scripts/package-mac-app.sh`, `git status`, `git diff`, `git add`, `git commit` (on feature branches only), `git checkout -b feat/...`, `git checkout main`, `git merge --squash ...`, `git push origin feat/...`, `gh pr ...`.
